My own little corner of the web / Az én kis sarkom a neten

## What you'll find here / Mit találsz itt

- Developer logs and experiments / Fejlesztői naplók és kísérletek  
- Personal projects and prototypes / Személyes projektek és prototípusok  
- Random thoughts worth saving (imho) / Véletlenszerű gondolatok, amiket érdemes megőrizni (szvsz)

## Technical notes / Technikai megjegyzések

- Built with plain HTML, CSS, and JavaScript / Egyszerű HTML, CSS és JavaScript alapokon  
- README fetched and rendered as the homepage / A README kerül betöltésre és megjelenítésre a kezdőlapon  
- Hosted on GitHub Pages / GitHub Pages-en hosztolva  

---

### Update — 2026.01.02

...later on that day, finished an old idea.  
It's a VOID — you can write anything into it.  
